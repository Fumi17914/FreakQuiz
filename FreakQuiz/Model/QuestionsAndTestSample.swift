...
class QuestionsAndTestSample {
    ...
    var questions: [Question] = [
        ...
        Question(id: 45, mode: Question.Mode(rawValue: 1) ?? .hard, question: "¿Cuántos años está atrapado el genio en la lámpara en Aladín?", options: ["10.000", "1.000", "100.000", "100.000"], answer: 0),
        ...
        Question(id: 45, mode: Question.Mode(rawValue: 2) ?? .fast, question: "¿Cuántos años está atrapado el genio en la lámpara en Aladín?", options: ["10.000", "1.000", "100.000", "100.000"], answer: 0),
